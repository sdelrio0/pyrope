...
// import { difference, intersection, isObject, isArray, isBoolean, isString, pluck, isEmpty } from 'underscore';
...
//
//   const { tableName, tablePrefix, tableSuffix, items } = opts;
//
//   // General validations
...
//       return findByIndex({
//         tableName: (tablePrefix || '') + tableName + (tableSuffix || ''),
//         index: currIndex
...
//     const params = {
//       RequestItems: {
//         [(tablePrefix || '') + tableName + (tableSuffix || '')]: deleteRequests
//       }
//     };
//
