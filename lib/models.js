...
export default class PyropeModel {
   ...
   * @returns {Promise<object>} - The retrieved record map. Rejects if record is not found.
   */
  get(index) {
   ...
   * @param {string} opts.fieldName - fieldName. Passed by the resolver function from GraphQL. ie. the name of the Query or Mutation.
   * @returns {Promise<object>} - A promise tha resolves to the updated record fields.
   */
